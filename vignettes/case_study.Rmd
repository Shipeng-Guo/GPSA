---
title: "GPSA Case Study: 完整功能演示"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{GPSA Case Study}
...
Viral mimicry是一种细胞状态，特征为：
- 干扰素响应 **上调** (IFN-α, IFN-γ)
- 细胞周期 **下调** (E2F targets, G2M checkpoint)
...
双模式评分区分两种场景：
- **Phenocopy (Score_bi)**: min(所有通道NES_signed)，要求所有通道都满足
- **Discovery (Score_uni)**: max(所有通道NES_signed)，只要某通道特别强
